...
const PARAMS = {
    ...
    L005: { name: 'Charge Period 1 Start',        description: 'Charge time period 1 start — seconds from midnight (t1_ch_start)' },
    L006: { name: 'Charge Period 1 End',          description: 'Charge time period 1 end — seconds from midnight (t1_ch_end)' },
    L007: { name: 'Charge Period 2 Start',        description: 'Charge time period 2 start — seconds from midnight (t2_ch_start)' },
    L008: { name: 'Charge Period 2 End',          description: 'Charge time period 2 end — seconds from midnight (t2_ch_end)' },
    L009: { name: 'Charge Period 3 Start',        description: 'Charge time period 3 start — seconds from midnight (t3_ch_start); 0 = disabled' },
    L010: { name: 'Charge Period 3 End',          description: 'Charge time period 3 end — seconds from midnight (t3_ch_end); 0 = disabled' },
    L011: { name: 'Discharge Period 1 Start',     description: 'Discharge time period 1 start — seconds from midnight (t4_ch_start); 0 = disabled' },
    L012: { name: 'Discharge Period 1 End',       description: 'Discharge time period 1 end — seconds from midnight (t4_ch_end); 0 = disabled' },
    L013: { name: 'Discharge Period 2 Start',     description: 'Discharge time period 2 start — seconds from midnight (t5_ch_start); 0 = disabled' },
    L014: { name: 'Discharge Period 2 End',       description: 'Discharge time period 2 end — seconds from midnight (t5_ch_end); 0 = disabled' },
    L015: { name: 'Discharge Period 3 Start',     description: 'Discharge time period 3 start — seconds from midnight (t6_ch_start); 0 = disabled' },
    L016: { name: 'Discharge Period 3 End',       description: 'Discharge time period 3 end — seconds from midnight (t6_ch_end); 0 = disabled' },
    ...
    P055: { name: 'Grid Active Power',            description: 'Net active power',  unit: 'W' },
